  ...
  <body>
    ...
    <div class="container">
     <div id=header>
		...
		<h3><b>Create E-VENDOR</b></h3>
      <form role="form" name="myForm" method="POST" action="addVendor.htm">
        <div class="form-group">
          <label for="eid">E-VENDOR Name</label>
          <input type="text" class="form-control" id="eid" name="vendorName" placeholder="Enter E-VENDOR USER NAME">
        </div>
        <div class="form-group">
